...
import { OMNIDEF } from './vplResumeSIMEnglish_def.js';
import tmpl from './vplResumeSIMEnglish.html';
import tmpl_nds from './vplResumeSIMEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplResumeSIMEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
