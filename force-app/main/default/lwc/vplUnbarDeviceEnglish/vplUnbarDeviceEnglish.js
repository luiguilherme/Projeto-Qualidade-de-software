...
import { OMNIDEF } from './vplUnbarDeviceEnglish_def.js';
import tmpl from './vplUnbarDeviceEnglish.html';
import tmpl_nds from './vplUnbarDeviceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplUnbarDeviceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
