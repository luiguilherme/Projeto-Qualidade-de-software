import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfValOrderDetailsStatusInvoice extends FlexCardMixin(LightningElement){
              ...
              @track Label={cmpFieldValueMissing:"This field value is missing."
        };
              pubsubEvent = [];
              customEvent = [];
