import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfValPortabilityActionsPage_13_Valentina extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfValPortabilityActionsPage_13_Valentina';
 ...
 this.registerEvents();
        ...
        this.pubsubEvent[1] = {
          [interpolateWithRegex(`RefreshPage`,this._allMergeFields,this._regexPattern,"noparse")]: this.handleEventAction.bind(this, data.events[1],1)
        };
        this.pubsubChannel1 = interpolateWithRegex(`valPortabilityActionsPage`,this._allMergeFields,this._regexPattern,"noparse");
