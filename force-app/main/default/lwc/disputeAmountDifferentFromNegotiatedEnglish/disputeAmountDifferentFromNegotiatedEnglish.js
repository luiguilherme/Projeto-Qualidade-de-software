...
import { OMNIDEF } from './disputeAmountDifferentFromNegotiatedEnglish_def.js';
import tmpl from './disputeAmountDifferentFromNegotiatedEnglish.html';
import tmpl_nds from './disputeAmountDifferentFromNegotiatedEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class disputeAmountDifferentFromNegotiatedEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
