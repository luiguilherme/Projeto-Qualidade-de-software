...
import { OMNIDEF } from './vplDeliveryOptionsEnglish_def.js';
import tmpl from './vplDeliveryOptionsEnglish.html';
import tmpl_nds from './vplDeliveryOptionsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplDeliveryOptionsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
