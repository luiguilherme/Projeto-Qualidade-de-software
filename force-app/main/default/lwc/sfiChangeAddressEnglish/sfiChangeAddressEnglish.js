...
import { OMNIDEF } from './sfiChangeAddressEnglish_def.js';
import tmpl from './sfiChangeAddressEnglish.html';
import tmpl_nds from './sfiChangeAddressEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sfiChangeAddressEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
