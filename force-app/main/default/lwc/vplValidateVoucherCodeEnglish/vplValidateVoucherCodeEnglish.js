...
import { OMNIDEF } from './vplValidateVoucherCodeEnglish_def.js';
import tmpl from './vplValidateVoucherCodeEnglish.html';
import tmpl_nds from './vplValidateVoucherCodeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplValidateVoucherCodeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
