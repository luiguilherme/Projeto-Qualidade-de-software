import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqProductSearch extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @track Label={CPQSearch:"CPQSearch",
...
baseinputvaluechange: this.handleEventAction.bind(this, data.events[2],2)
        ...
        this.pubsubEvent[1] = {
          cpqresponse: this.handleEventAction.bind(this, data.events[1],1),
apply_filter: this.handleEventAction.bind(this, data.events[3],3),
productlist: this.handleEventAction.bind(this, data.events[5],5),
selectedproductsevent: this.handleEventAction.bind(this, data.events[7],7),
result: this.handleEventAction.bind(this, data.events[8],8),
cpq_catalog_item_select_browse: this.handleEventAction.bind(this, data.events[9],9),
cpq_catalog_item_select_cart: this.handleEventAction.bind(this, data.events[10],10)
        };

        pubsub.register(`cpq_${this.recordId}`,this.pubsubEvent[1]);

        this.pubsubEvent[2] = {
          basetypeaheadinputchange: this.handleEventAction.bind(this, data.events[4],4),
baseinputvaluechange: this.handleEventAction.bind(this, data.events[6],6)
        };

        pubsub.register(`multiselectproductlist`,this.pubsubEvent[2]);
...
pubsub.unregister(`multiselectproductlist`,this.pubsubEvent[2]);
