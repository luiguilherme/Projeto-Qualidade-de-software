...
import { OMNIDEF } from './valReviewOrderEnglish_def.js';
import tmpl from './valReviewOrderEnglish.html';
import tmpl_nds from './valReviewOrderEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class valReviewOrderEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
