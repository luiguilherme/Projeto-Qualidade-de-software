...
import { OMNIDEF } from './valTicketDetailsEnglish_def.js';
import tmpl from './valTicketDetailsEnglish.html';
import tmpl_nds from './valTicketDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class valTicketDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
