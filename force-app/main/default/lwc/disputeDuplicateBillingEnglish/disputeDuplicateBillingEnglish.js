...
import { OMNIDEF } from './disputeDuplicateBillingEnglish_def.js';
import tmpl from './disputeDuplicateBillingEnglish.html';
import tmpl_nds from './disputeDuplicateBillingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class disputeDuplicateBillingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
