...
import { OMNIDEF } from './disputeNotRecognizeQualificationOrPlanChangeEnglish_def.js';
import tmpl from './disputeNotRecognizeQualificationOrPlanChangeEnglish.html';
import tmpl_nds from './disputeNotRecognizeQualificationOrPlanChangeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class disputeNotRecognizeQualificationOrPlanChangeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
