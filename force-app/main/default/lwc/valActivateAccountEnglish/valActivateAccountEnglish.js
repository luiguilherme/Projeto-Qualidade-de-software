...
import { OMNIDEF } from './valActivateAccountEnglish_def.js';
import tmpl from './valActivateAccountEnglish.html';
import tmpl_nds from './valActivateAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class valActivateAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
