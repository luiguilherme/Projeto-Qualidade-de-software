...
import { OMNIDEF } from './vplJoinJourneyAgentSessionEnglish_def.js';
import tmpl from './vplJoinJourneyAgentSessionEnglish.html';
import tmpl_nds from './vplJoinJourneyAgentSessionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplJoinJourneyAgentSessionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
