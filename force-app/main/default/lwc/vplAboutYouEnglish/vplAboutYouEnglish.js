...
import { OMNIDEF } from './vplAboutYouEnglish_def.js';
import tmpl from './vplAboutYouEnglish.html';
import tmpl_nds from './vplAboutYouEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplAboutYouEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
