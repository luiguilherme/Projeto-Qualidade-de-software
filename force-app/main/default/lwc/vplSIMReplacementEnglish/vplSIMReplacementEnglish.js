...
import { OMNIDEF } from './vplSIMReplacementEnglish_def.js';
import tmpl from './vplSIMReplacementEnglish.html';
import tmpl_nds from './vplSIMReplacementEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplSIMReplacementEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
