import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqPillsContainer extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
        ...
        this.pubsubEvent[0] = {
          result: this.handleEventAction.bind(this, data.events[0],0),
cpqselect: this.handleEventAction.bind(this, data.events[1],1)
        };
