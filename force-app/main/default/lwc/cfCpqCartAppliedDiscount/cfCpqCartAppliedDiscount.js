import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
      ...
      CPQNoAppliedDiscountsNew:"No Applied Discounts"
      };
              pubsubEvent = [];
              customEvent = [];
        ...
        this.pubsubEvent[0] = {
          cpq_discount_apply_response: this.handleEventAction.bind(this, data.events[0],0),
cpq_discount_delete_response: this.handleEventAction.bind(this, data.events[1],1)
        };
