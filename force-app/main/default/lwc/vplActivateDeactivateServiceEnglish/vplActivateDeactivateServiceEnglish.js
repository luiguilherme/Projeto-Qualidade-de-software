...
import { OMNIDEF } from './vplActivateDeactivateServiceEnglish_def.js';
import tmpl from './vplActivateDeactivateServiceEnglish.html';
import tmpl_nds from './vplActivateDeactivateServiceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplActivateDeactivateServiceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
