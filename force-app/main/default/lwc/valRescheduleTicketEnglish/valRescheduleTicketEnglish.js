...
import { OMNIDEF } from './valRescheduleTicketEnglish_def.js';
import tmpl from './valRescheduleTicketEnglish.html';
import tmpl_nds from './valRescheduleTicketEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class valRescheduleTicketEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
