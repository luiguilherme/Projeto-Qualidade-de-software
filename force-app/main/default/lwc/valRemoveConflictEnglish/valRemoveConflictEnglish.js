...
import { OMNIDEF } from './valRemoveConflictEnglish_def.js';
import tmpl from './valRemoveConflictEnglish.html';
import tmpl_nds from './valRemoveConflictEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class valRemoveConflictEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
