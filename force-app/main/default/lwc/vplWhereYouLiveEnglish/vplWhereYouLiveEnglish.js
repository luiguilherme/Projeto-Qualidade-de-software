...
import { OMNIDEF } from './vplWhereYouLiveEnglish_def.js';
import tmpl from './vplWhereYouLiveEnglish.html';
import tmpl_nds from './vplWhereYouLiveEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplWhereYouLiveEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
