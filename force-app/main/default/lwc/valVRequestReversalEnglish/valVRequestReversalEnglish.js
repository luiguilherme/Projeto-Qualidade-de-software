...
import { OMNIDEF } from './valVRequestReversalEnglish_def.js';
import tmpl from './valVRequestReversalEnglish.html';
import tmpl_nds from './valVRequestReversalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class valVRequestReversalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
