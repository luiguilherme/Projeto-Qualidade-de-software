...
import { OMNIDEF } from './disputeDisputeUnifiedSupportflowEnglish_def.js';
import tmpl from './disputeDisputeUnifiedSupportflowEnglish.html';
import tmpl_nds from './disputeDisputeUnifiedSupportflowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class disputeDisputeUnifiedSupportflowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
