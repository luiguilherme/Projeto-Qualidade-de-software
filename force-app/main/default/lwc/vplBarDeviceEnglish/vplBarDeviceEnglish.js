...
import { OMNIDEF } from './vplBarDeviceEnglish_def.js';
import tmpl from './vplBarDeviceEnglish.html';
import tmpl_nds from './vplBarDeviceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplBarDeviceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
