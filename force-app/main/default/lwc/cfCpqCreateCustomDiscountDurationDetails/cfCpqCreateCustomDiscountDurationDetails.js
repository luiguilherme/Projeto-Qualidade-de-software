import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqCreateCustomDiscountDurationDetails extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
      ...
      CPQDiscountMonths:"Months",
      CPQDiscountEndDate:"End Date"
      };
              pubsubEvent = [];
              customEvent = [];
