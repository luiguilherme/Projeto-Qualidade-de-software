...
import { OMNIDEF } from './panSendExtractEnglish_def.js';
import tmpl from './panSendExtractEnglish.html';
import tmpl_nds from './panSendExtractEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class panSendExtractEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
