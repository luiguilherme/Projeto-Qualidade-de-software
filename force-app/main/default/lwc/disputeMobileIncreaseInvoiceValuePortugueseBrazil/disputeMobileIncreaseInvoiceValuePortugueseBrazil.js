...
import { OMNIDEF } from './disputeMobileIncreaseInvoiceValuePortugueseBrazil_def.js';
import tmpl from './disputeMobileIncreaseInvoiceValuePortugueseBrazil.html';
import tmpl_nds from './disputeMobileIncreaseInvoiceValuePortugueseBrazil_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class disputeMobileIncreaseInvoiceValuePortugueseBrazil extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
