...
import { OMNIDEF } from './valPortabilityRemoveSuspensionEnglish_def.js';
import tmpl from './valPortabilityRemoveSuspensionEnglish.html';
import tmpl_nds from './valPortabilityRemoveSuspensionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class valPortabilityRemoveSuspensionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
