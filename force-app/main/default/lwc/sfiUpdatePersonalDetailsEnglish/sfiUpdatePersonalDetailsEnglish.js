...
import { OMNIDEF } from './sfiUpdatePersonalDetailsEnglish_def.js';
import tmpl from './sfiUpdatePersonalDetailsEnglish.html';
import tmpl_nds from './sfiUpdatePersonalDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sfiUpdatePersonalDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
