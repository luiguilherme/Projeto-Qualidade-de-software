...
import { OMNIDEF } from './vplChooseAddonEnglish_def.js';
import tmpl from './vplChooseAddonEnglish.html';
import tmpl_nds from './vplChooseAddonEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplChooseAddonEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
