...
import { OMNIDEF } from './vplChooseNumberEnglish_def.js';
import tmpl from './vplChooseNumberEnglish.html';
import tmpl_nds from './vplChooseNumberEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplChooseNumberEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
