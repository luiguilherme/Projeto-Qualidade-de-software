...
import { OMNIDEF } from './vplCashAndBundleTopUpsEnglish_def.js';
import tmpl from './vplCashAndBundleTopUpsEnglish.html';
import tmpl_nds from './vplCashAndBundleTopUpsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplCashAndBundleTopUpsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
