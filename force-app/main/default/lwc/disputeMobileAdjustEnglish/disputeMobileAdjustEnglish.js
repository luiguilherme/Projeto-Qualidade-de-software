...
import { OMNIDEF } from './disputeMobileAdjustEnglish_def.js';
import tmpl from './disputeMobileAdjustEnglish.html';
import tmpl_nds from './disputeMobileAdjustEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class disputeMobileAdjustEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
