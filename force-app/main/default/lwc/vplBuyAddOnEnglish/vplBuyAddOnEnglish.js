...
import { OMNIDEF } from './vplBuyAddOnEnglish_def.js';
import tmpl from './vplBuyAddOnEnglish.html';
import tmpl_nds from './vplBuyAddOnEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplBuyAddOnEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
