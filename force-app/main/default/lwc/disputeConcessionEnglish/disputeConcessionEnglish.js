...
import { OMNIDEF } from './disputeConcessionEnglish_def.js';
import tmpl from './disputeConcessionEnglish.html';
import tmpl_nds from './disputeConcessionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class disputeConcessionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
