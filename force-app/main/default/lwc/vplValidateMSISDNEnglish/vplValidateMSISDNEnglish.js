...
import { OMNIDEF } from './vplValidateMSISDNEnglish_def.js';
import tmpl from './vplValidateMSISDNEnglish.html';
import tmpl_nds from './vplValidateMSISDNEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplValidateMSISDNEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
