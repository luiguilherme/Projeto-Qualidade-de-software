...
import { OMNIDEF } from './vplSelectCatalogProductEnglish_def.js';
import tmpl from './vplSelectCatalogProductEnglish.html';
import tmpl_nds from './vplSelectCatalogProductEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplSelectCatalogProductEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
