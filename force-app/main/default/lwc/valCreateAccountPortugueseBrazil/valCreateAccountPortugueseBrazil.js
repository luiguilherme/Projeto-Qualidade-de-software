...
import { OMNIDEF } from './valCreateAccountPortugueseBrazil_def.js';
import tmpl from './valCreateAccountPortugueseBrazil.html';
import tmpl_nds from './valCreateAccountPortugueseBrazil_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class valCreateAccountPortugueseBrazil extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
