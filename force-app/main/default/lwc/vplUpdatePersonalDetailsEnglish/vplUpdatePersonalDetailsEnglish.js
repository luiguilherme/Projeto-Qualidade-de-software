...
import { OMNIDEF } from './vplUpdatePersonalDetailsEnglish_def.js';
import tmpl from './vplUpdatePersonalDetailsEnglish.html';
import tmpl_nds from './vplUpdatePersonalDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplUpdatePersonalDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
