...
import { OMNIDEF } from './vplOrderSummaryEnglish_def.js';
import tmpl from './vplOrderSummaryEnglish.html';
import tmpl_nds from './vplOrderSummaryEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplOrderSummaryEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
