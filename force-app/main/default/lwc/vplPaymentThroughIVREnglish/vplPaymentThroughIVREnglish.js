...
import { OMNIDEF } from './vplPaymentThroughIVREnglish_def.js';
import tmpl from './vplPaymentThroughIVREnglish.html';
import tmpl_nds from './vplPaymentThroughIVREnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplPaymentThroughIVREnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
