import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
 ...
 this.registerEvents();
        ...
        this.pubsubEvent[1] = {
          [interpolateWithRegex(`customerfeedback`,this._allMergeFields,this._regexPattern,"noparse")]: this.handleEventAction.bind(this, data.events[1],1)
        };
        this.pubsubChannel1 = interpolateWithRegex(`updatelistfilterparms`,this._allMergeFields,this._regexPattern,"noparse");
