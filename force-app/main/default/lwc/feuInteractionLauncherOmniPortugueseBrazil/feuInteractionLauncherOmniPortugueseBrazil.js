...
import { OMNIDEF } from './feuInteractionLauncherOmniPortugueseBrazil_def.js';
import tmpl from './feuInteractionLauncherOmniPortugueseBrazil.html';
import tmpl_nds from './feuInteractionLauncherOmniPortugueseBrazil_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class feuInteractionLauncherOmniPortugueseBrazil extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
