...
import { OMNIDEF } from './vplChangeAddressEnglish_def.js';
import tmpl from './vplChangeAddressEnglish.html';
import tmpl_nds from './vplChangeAddressEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplChangeAddressEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
