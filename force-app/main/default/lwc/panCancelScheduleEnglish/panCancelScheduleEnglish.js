...
import { OMNIDEF } from './panCancelScheduleEnglish_def.js';
import tmpl from './panCancelScheduleEnglish.html';
import tmpl_nds from './panCancelScheduleEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class panCancelScheduleEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
