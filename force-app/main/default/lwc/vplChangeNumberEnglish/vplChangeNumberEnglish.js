...
import { OMNIDEF } from './vplChangeNumberEnglish_def.js';
import tmpl from './vplChangeNumberEnglish.html';
import tmpl_nds from './vplChangeNumberEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplChangeNumberEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
