...
import { OMNIDEF } from './vplSuspendSIMEnglish_def.js';
import tmpl from './vplSuspendSIMEnglish.html';
import tmpl_nds from './vplSuspendSIMEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplSuspendSIMEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
