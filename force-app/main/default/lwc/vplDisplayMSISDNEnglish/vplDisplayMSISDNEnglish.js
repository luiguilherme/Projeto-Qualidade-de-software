...
import { OMNIDEF } from './vplDisplayMSISDNEnglish_def.js';
import tmpl from './vplDisplayMSISDNEnglish.html';
import tmpl_nds from './vplDisplayMSISDNEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplDisplayMSISDNEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
