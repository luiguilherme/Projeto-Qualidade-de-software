...
import { OMNIDEF } from './valConfigureLinePortugueseBrazil_def.js';
import tmpl from './valConfigureLinePortugueseBrazil.html';
import tmpl_nds from './valConfigureLinePortugueseBrazil_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class valConfigureLinePortugueseBrazil extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
