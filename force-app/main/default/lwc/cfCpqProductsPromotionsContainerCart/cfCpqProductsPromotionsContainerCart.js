import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqProductsPromotionsContainerCart extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
        ...
        this.pubsubEvent[0] = {
          cpq_load_more_promotions_cart: this.handleEventAction.bind(this, data.events[0],0),
cpq_load_more_products_cart: this.handleEventAction.bind(this, data.events[1],1),
cpq_select_product: this.handleEventAction.bind(this, data.events[2],2),
cpq_update_products_cart: this.handleEventAction.bind(this, data.events[3],3),
cpq_remove_multiselect_incontainer_cart: this.handleEventAction.bind(this, data.events[4],4),
cpq_uncheck_all_products_cart: this.handleEventAction.bind(this, data.events[5],5),
cpq_select_all_products_checkbox: this.handleEventAction.bind(this, data.events[6],6),
cpq_mark_select_all_checkbox_cart: this.handleEventAction.bind(this, data.events[7],7)
        };
