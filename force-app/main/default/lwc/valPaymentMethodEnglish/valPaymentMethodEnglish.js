...
import { OMNIDEF } from './valPaymentMethodEnglish_def.js';
import tmpl from './valPaymentMethodEnglish.html';
import tmpl_nds from './valPaymentMethodEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class valPaymentMethodEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
