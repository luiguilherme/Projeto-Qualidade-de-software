...
import { OMNIDEF } from './valBillingAccountEnglish_def.js';
import tmpl from './valBillingAccountEnglish.html';
import tmpl_nds from './valBillingAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class valBillingAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
