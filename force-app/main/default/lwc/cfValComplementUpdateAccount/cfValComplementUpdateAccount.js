import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfValComplementUpdateAccount extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfValComplementUpdateAccount';
        ...
        @api set cfMainComplementOne(val) {
          ...
          return this._sessionApiVars["MainComplementOne"] || "undefined";
        }
        ...
        @api set cfMainComplementTypeFour(val) {
          ...
          return this._sessionApiVars["MainComplementTypeFour"] || "";
        }
        ...
        @api set cfShow(val) {
          ...
          return this._sessionApiVars["Show"] || "";
        }
