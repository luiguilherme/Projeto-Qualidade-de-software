import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqAsyncJobStatus extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
              ...
              @track Label={CPQAsyncProcessingCompletedMessage:"Bulk updates completed.",
      CPQAsyncProcessingInProgressMessage:"Validation and pricing of bulk change in progress. You'll be notified when it's ready.",
      LoadingUC:"Loading"
      };
              pubsubEvent = [];
              customEvent = [];
        ...
        this.pubsubEvent[0] = {
          cpq_update_bulk_async_job_status: this.handleEventAction.bind(this, data.events[0],0)
        };
