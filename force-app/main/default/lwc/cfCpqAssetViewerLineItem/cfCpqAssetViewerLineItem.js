import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqAssetViewerLineItem extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
        ...
        this.pubsubEvent[0] = {
          select_record: this.handleEventAction.bind(this, data.events[0],0),
selectallassets: this.handleEventAction.bind(this, data.events[1],1)
        };
