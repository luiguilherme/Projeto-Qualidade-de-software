import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSelectTypeExtracts extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfSelectTypeExtracts';
 ...
 this.registerEvents();
                this.setAttribute(
                  "class",
                  "card-a5W78000000L0QyEAK"
                );
                this.loadCustomStylesheetAttachement("00P7800000BIFh8EAH");
        ...
        this.pubsubChannel0 = interpolateWithRegex(`valSelectTypeExtract`,this._allMergeFields,this._regexPattern,"noparse");
