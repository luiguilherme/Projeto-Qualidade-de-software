import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfValCaseActionsPage extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfValCaseActionsPage';
        ...
        @api set cfCaseReturn(val) {
          if(typeof val !== "undefined") {
            this._sessionApiVars["CaseReturn"] = val;
          }
        } get cfCaseReturn() {
          return this._sessionApiVars["CaseReturn"] || "";
        }
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`valCaseActionsPage`,this._allMergeFields,this._regexPattern,"noparse");
