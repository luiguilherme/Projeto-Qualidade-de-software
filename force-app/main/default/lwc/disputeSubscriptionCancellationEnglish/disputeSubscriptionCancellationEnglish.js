...
import { OMNIDEF } from './disputeSubscriptionCancellationEnglish_def.js';
import tmpl from './disputeSubscriptionCancellationEnglish.html';
import tmpl_nds from './disputeSubscriptionCancellationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class disputeSubscriptionCancellationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
