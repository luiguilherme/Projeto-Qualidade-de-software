import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqCatalogSelectionMenu extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
              ...
              @track Label={CPQBrowseCategories:"Browse Categories",
      CPQDone:"Done",
      CPQSelectCategory:"Select Category"
      };
              pubsubEvent = [];
              customEvent = [];
