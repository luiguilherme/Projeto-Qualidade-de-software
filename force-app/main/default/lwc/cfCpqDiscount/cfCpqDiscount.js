import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqDiscount extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
      ...
      CPQAppliedDiscounts:"Applied Discounts"
      };
              pubsubEvent = [];
              customEvent = [];
        ...
        this.pubsubEvent[0] = {
          cpq_qualified: this.handleEventAction.bind(this, data.events[0],0)
        };
