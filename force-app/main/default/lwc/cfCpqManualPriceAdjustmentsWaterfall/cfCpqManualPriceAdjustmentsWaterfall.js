import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
        ...
        this.pubsubEvent[0] = {
          cpq_adjustment_delete: this.handleEventAction.bind(this, data.events[0],0),
cpq_chargetype: this.handleEventAction.bind(this, data.events[1],1),
cpq_adjustment_apply: this.handleEventAction.bind(this, data.events[2],2),
cpq_adjustment_delete_click: this.handleEventAction.bind(this, data.events[3],3),
cpq_adjustment_apply_click: this.handleEventAction.bind(this, data.events[4],4)
        };
