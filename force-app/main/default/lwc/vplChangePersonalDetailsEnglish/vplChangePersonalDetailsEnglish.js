...
import { OMNIDEF } from './vplChangePersonalDetailsEnglish_def.js';
import tmpl from './vplChangePersonalDetailsEnglish.html';
import tmpl_nds from './vplChangePersonalDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplChangePersonalDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
