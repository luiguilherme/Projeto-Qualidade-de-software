...
import { OMNIDEF } from './valRemoveConflict48hWindowEnglish_def.js';
import tmpl from './valRemoveConflict48hWindowEnglish.html';
import tmpl_nds from './valRemoveConflict48hWindowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class valRemoveConflict48hWindowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
