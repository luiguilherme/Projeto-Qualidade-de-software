...
import { OMNIDEF } from './valSalesJourneyPortugueseBrazil_def.js';
import tmpl from './valSalesJourneyPortugueseBrazil.html';
import tmpl_nds from './valSalesJourneyPortugueseBrazil_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class valSalesJourneyPortugueseBrazil extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
