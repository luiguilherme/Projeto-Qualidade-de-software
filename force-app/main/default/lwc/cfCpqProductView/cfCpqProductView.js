import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
      ...
      CPQProductsNotAvailable:"No products available.",
      ...
      CPQSelectAll:"Select All"
        ...
        this.pubsubEvent[0] = {
          cpq_mark_select_all_checkbox: this.handleEventAction.bind(this, data.events[0],0)
        };

        pubsub.register(`cpq_${this.recordId}_1`,this.pubsubEvent[0]);

              }

              unregisterEvents(){
                pubsub.unregister(`cpq_${this.recordId}_1`,this.pubsubEvent[0]);
