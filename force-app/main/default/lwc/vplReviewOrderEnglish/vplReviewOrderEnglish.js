...
import { OMNIDEF } from './vplReviewOrderEnglish_def.js';
import tmpl from './vplReviewOrderEnglish.html';
import tmpl_nds from './vplReviewOrderEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplReviewOrderEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
