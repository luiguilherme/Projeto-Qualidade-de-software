...
import { OMNIDEF } from './disputeInvoicesFlowEnglish_def.js';
import tmpl from './disputeInvoicesFlowEnglish.html';
import tmpl_nds from './disputeInvoicesFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class disputeInvoicesFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
