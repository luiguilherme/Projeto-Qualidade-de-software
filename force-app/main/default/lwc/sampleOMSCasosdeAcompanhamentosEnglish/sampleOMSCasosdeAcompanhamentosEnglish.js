...
import { OMNIDEF } from './sampleOMSCasosdeAcompanhamentosEnglish_def.js';
import tmpl from './sampleOMSCasosdeAcompanhamentosEnglish.html';
import tmpl_nds from './sampleOMSCasosdeAcompanhamentosEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sampleOMSCasosdeAcompanhamentosEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
