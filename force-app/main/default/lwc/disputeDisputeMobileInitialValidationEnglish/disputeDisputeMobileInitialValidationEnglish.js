...
import { OMNIDEF } from './disputeDisputeMobileInitialValidationEnglish_def.js';
import tmpl from './disputeDisputeMobileInitialValidationEnglish.html';
import tmpl_nds from './disputeDisputeMobileInitialValidationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class disputeDisputeMobileInitialValidationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
