...
import { OMNIDEF } from './sfiChangePersonalDetailsEnglish_def.js';
import tmpl from './sfiChangePersonalDetailsEnglish.html';
import tmpl_nds from './sfiChangePersonalDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sfiChangePersonalDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
