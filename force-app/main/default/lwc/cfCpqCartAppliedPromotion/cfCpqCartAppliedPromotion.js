import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqCartAppliedPromotion extends FlexCardMixin(LightningElement){
              ...
              @track Label={CPQNoAppliedPromotions:"No Applied Promotions",
      CPQAppliedPromotions:"Applied Promotions"
      };
              pubsubEvent = [];
              customEvent = [];
        ...
        this.pubsubEvent[0] = {
          cpq_update_cart_summary: this.handleEventAction.bind(this, data.events[0],0),
cpq_update_cart_persistentcartview: this.handleEventAction.bind(this, data.events[1],1),
cpq_update_cart_detailview: this.handleEventAction.bind(this, data.events[2],2)
        };
