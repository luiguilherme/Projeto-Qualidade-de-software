...
import { OMNIDEF } from './panCreateNoteEnglish_def.js';
import tmpl from './panCreateNoteEnglish.html';
import tmpl_nds from './panCreateNoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class panCreateNoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
