import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqCreateCustomDiscountBasicInfo extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
              ...
              @track Label={CPQDescription:"Description",
      CPQDiscountAllocation:"Allocation",
      Name:"Name"
      };
              pubsubEvent = [];
              customEvent = [];
