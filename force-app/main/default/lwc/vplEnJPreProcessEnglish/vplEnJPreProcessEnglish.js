...
import { OMNIDEF } from './vplEnJPreProcessEnglish_def.js';
import tmpl from './vplEnJPreProcessEnglish.html';
import tmpl_nds from './vplEnJPreProcessEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplEnJPreProcessEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
