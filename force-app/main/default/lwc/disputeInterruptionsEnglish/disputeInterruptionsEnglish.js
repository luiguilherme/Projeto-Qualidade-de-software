...
import { OMNIDEF } from './disputeInterruptionsEnglish_def.js';
import tmpl from './disputeInterruptionsEnglish.html';
import tmpl_nds from './disputeInterruptionsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class disputeInterruptionsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
