...
import { OMNIDEF } from './vplManageLostAndStolenDevicesEnglish_def.js';
import tmpl from './vplManageLostAndStolenDevicesEnglish.html';
import tmpl_nds from './vplManageLostAndStolenDevicesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplManageLostAndStolenDevicesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
