...
import { OMNIDEF } from './panScheduleExtractEnglish_def.js';
import tmpl from './panScheduleExtractEnglish.html';
import tmpl_nds from './panScheduleExtractEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class panScheduleExtractEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
