import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfFC_panInvoice extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
 ...
 this.registerEvents();
            ...
            this.customEventName0 = interpolateWithRegex(`pesquisanotafiscal`,this._allMergeFields,this._regexPattern,"noparse");
